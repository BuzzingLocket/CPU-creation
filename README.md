...
- There will be a BOM of ICs I purchased but the general parts are assumed to be had when making it
  - Things like Resistors, DIP switches, Buttons, Toggles, Capacitors, Diodes
    - I actually dont have Diodes but only LEDs
   
# September 25th 2026
- Just opened the repo, things will be added as I get more free
- BOM of ICs added
